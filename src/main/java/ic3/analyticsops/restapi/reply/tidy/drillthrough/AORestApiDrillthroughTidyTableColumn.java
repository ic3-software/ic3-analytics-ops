...
public class AORestApiDrillthroughTidyTableColumn extends AORestApiTidyTableColumn
{
    ...
    public AORestApiDrillthroughTidyTable getTable()
    {
        return (AORestApiDrillthroughTidyTable) table;
    }
    ...
    public void assertEquals(AORestApiTidyTableColumn other, boolean valueOnly, double delta)
    {
        ...
        final AORestApiDrillthroughTidyTableColumn actual = (AORestApiDrillthroughTidyTableColumn) other;
